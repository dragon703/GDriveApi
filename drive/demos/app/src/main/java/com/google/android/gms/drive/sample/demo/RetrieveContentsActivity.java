                ...
                .continueWithTask(new Continuation<DriveContents, Task<Void>>() {
                    ...
                    public Task<Void> then(@NonNull Task<DriveContents> task) throws Exception {
                        ...
                        try (BufferedReader reader = new BufferedReader(
                            ...
                            RetrieveContentsActivity.this.showMessage(RetrieveContentsActivity.this.getString(R.string.content_loaded));
                            mFileContents.setText(builder.toString());
                        }
                        // [END drive_android_read_as_string]
                        // [END_EXCLUDE]
                        // [START drive_android_discard_contents]
                        Task<Void> discardTask = RetrieveContentsActivity.this.getDriveResourceClient().discardContents(contents);
